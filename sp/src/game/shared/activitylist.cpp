...
#ifdef EZ2
	REGISTER_SHARED_ACTIVITY( ACT_RELOAD_PULSE_PISTOL )
	REGISTER_SHARED_ACTIVITY( ACT_RELOAD_PULSE_PISTOL_LOW )
	REGISTER_SHARED_ACTIVITY( ACT_CHARGE_PULSE_PISTOL )
	REGISTER_SHARED_ACTIVITY( ACT_CHARGE_PULSE_PISTOL_LOW )
	REGISTER_SHARED_ACTIVITY( ACT_GESTURE_RELOAD_PULSE_PISTOL )
	REGISTER_SHARED_ACTIVITY( ACT_GESTURE_CHARGE_PULSE_PISTOL )
#endif
