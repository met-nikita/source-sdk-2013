...
//===========================
	...
	//===========================
	// EZ2 Specific Activities
	//==========================
	ADD_ACTIVITY_TO_SR( ACT_VM_COMMAND_SEND );
	ADD_ACTIVITY_TO_SR( ACT_VM_COMMAND_RECALL );
	ADD_ACTIVITY_TO_SR( ACT_VM_FIRSTDRAW );
	ADD_ACTIVITY_TO_SR( ACT_VM_FIRSTDRAW_EMPTY );
	ADD_ACTIVITY_TO_SR( ACT_VM_FIRSTDRAW_QUICK );
	ADD_ACTIVITY_TO_SR( ACT_VM_FIRSTDRAW_PUMP );

#ifdef EZ2
	ADD_ACTIVITY_TO_SR( ACT_RELOAD_PULSE_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_RELOAD_PULSE_PISTOL_LOW );
	ADD_ACTIVITY_TO_SR( ACT_CHARGE_PULSE_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_CHARGE_PULSE_PISTOL_LOW );
	ADD_ACTIVITY_TO_SR( ACT_GESTURE_RELOAD_PULSE_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_GESTURE_CHARGE_PULSE_PISTOL );
#endif
}
