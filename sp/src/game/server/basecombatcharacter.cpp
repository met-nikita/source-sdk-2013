...
ConVar ai_force_serverside_ragdoll( "ai_force_serverside_ragdoll", "0" );
//unfortunately, serverside ragdoll eat up to 66% of network traffic and give this ugly stutter when you kill enemies, no matter how low your ping is, so it's best to leave them disabled by default for coop
#endif
