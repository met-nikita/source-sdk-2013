...
BEGIN_RECV_TABLE_NOBASE( CPlayerLocalData, DT_Local )
	...
	RecvPropBool	(RECVINFO(m_bHoldingItem)),
	RecvPropBool(RECVINFO(m_bPlayerCollisionDisabled)),
...
BEGIN_PREDICTION_DATA_NO_BASE( CPlayerLocalData )
	...
	DEFINE_PRED_FIELD(m_bHoldingItem, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE),
	DEFINE_PRED_FIELD(m_bPlayerCollisionDisabled, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE),
